...
const HouseHold = () => {
  ...
  const filteredData =
    filter === "all"
      ? houseHolds
      : houseHolds.filter((item) => item.status === filter);
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="shadow-main p-[30px] flex flex-col gap-[30px] rounded-xl">
              <span className="text-sm lg:text-[18px] text-[#333333] leading-[24px]">
                Gather valuable insights from villagers to better understand
                their community. Focus on essential details such as age, gender,
                marital status, and other household identifiers. These records
                create a comprehensive view of the population, helping to build
                a clearer and more accurate community profile.
              </span>
          ...
          <div className="flex flex-col gap-[25px]">
            ...
            {filteredData && filteredData.length > 0 ? (
                    ...
                    <div className="flex flex-col gap-1">
                      <div className="flex items-center md:items-start justify-between md:justify-start">
                        <div className="text-base truncate flex gap-1 lg:text-[18px] font-medium leading-none tracking-[0.02em]">
                          <span>{item?.householdHeadName} </span>
                          <span
                            className={cn(
                      ...
                      <div className="flex flex-col gap-2">
                        <div className="flex text-gray-700 truncate items-center flex gap-1">
                          ...
                          <span className="">{item.houseAddress}</span>
                        </div>
                      </div>
              ...
              <div className="flex items-center flex-col py-14 justify-center gap-4">
                ...
                {filter === "all" ? (
                  <h2 className="font-medium">No House hold form submitted</h2>
                ) : (
