...
const Problems = () => {
  ...
  const { rootCauseData } = useRootCause();
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="shadow-main p-[30px] flex flex-col gap-[30px] rounded-xl">
            <span className="text-sm lg:text-[18px] text-[#333333] leading-[24px]">
              This page provides a summary of identified problems across key
              system areas, their underlying causes, proposed solutions, and
              responsible persons. It allows stakeholders to quickly review
              challenges, track resolutions, and plan interventions across all
