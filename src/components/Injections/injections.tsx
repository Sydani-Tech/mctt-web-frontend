...
import { StatusDropdown } from "../Demographics/StatusDropdown";
// import { StatusDropdown } from "./StatusDropdown";

const InjectionSupplies = () => {
  ...
  const filteredData =
    filter === "all"
      ? injectionSupplies
      : injectionSupplies.filter((item) => item.status === filter);
  return (
    <PageLayout>
      <div className="w-full gap-14 flex flex-col pb-16">
        <div className="flex flex-col gap-6">
          ...
          >
            ...
            <span className="text-main leading-none tracking-[0.02em] text-base lg:text-[24px]">
              Injection Supplies
            </span>
          </div>
          <div className="shadow-main p-[30px] flex flex-col gap-[30px] rounded-xl">
            <span className="text-sm lg:text-[18px] text-[#333333] leading-">
              Collect information from villagers to build a clearer picture of
              their community. The data should focus on key demographic details
              such as age, gender, marital status, and other personal
              identifiers. Include household size to ensure the records provide
              a well-rounded view of the population.
            </span>
        ...
        <div className="flex flex-col gap-[25px]">
          <div className="flex items-center justify-between px-4 lg:px-[30px]">
            <div className="flex flex-row items-center md:items-start justify-between md:justify-start w-full md:w-auto md:flex-col gap-2">
              ...
              <span className="text-[#4A4A4AB2] text-xs">
                {injectionSupplies.length} total
              </span>
            </div>
          ...
          <div className="flex flex-col gap-2 p-4 lg:p-[30px] bg-[#F9FCFF] shadow-light rounded-xl ">
              ...
              >
                <div className="flex flex-col gap-3.5">
                  ...
                  <span className="text-[#33333380] text-sm">
                    Submitted on Feb 18, 2025 at 2:30 PM
                  </span>
                </div>
                <div className="flex gap-4 items-center">
                  <div className="w-full md:w-[124px] items-center justify-center flex flex-row text-main rounded-lg hover:cursor-pointer hover:bg-main/5 transition duration-300 bg-main/10 border border border-main/50 gap-3 px-4 py-3">
                    <IoEye />
...
export default InjectionSupplies;
